...
class GolfModel {
    ...
    // All three points (F, M, B) physically walked on-course 2026-03-26 (BasicAirData GPS Logger, KML export).
    // H13/H14 corrected 2026-03-28: GPS logger mislabelled them — confirmed by Golf API cross-reference.
    private var _holes as Array = [
        ...
        // H13
        [  4,   2,  53.28523855d,  -8.84631114d,  53.28510435d,  -8.84630322d,  53.28494376d,  -8.84648910d,  424 ],
        // H14
        [  4,   4,  53.28755124d,  -8.84343407d,  53.28760524d,  -8.84320375d,  53.28762663d,  -8.84295364d,  437 ],
        // H15
